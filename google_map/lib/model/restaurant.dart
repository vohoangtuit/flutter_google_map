class Restaurant{
  ...
  List<Restaurant> initData(){
    ...
    data.add(new Restaurant(id:"3",name: 'Bò Lá Lốt Tân Quy',image: 'https://food.fnr.sndimg.com/content/dam/images/food/fullset/2018/6/0/FN_snapchat_coachella_wingman%20.jpeg.rend.hgtvcom.616.462.suffix/1523633513292.jpeg', address:'24 Đường 67, Tân Quy, Quận 7, Thành phố Hồ Chí Minh, Việt Nam',latitude: 10.7443983, longitude:106.7054696, description:'Bò lá lốt siêu ngon, thơm và ngọt. Ăn từ khi giá 25k, nay đã lên 45k rồi.',rating: 4.5));
